...
import { CustomerName, OrderStatus, PaymentType, Supplier } from '@/components/core/json/selectOption';
										...
										<div className="row">
												...
												<div className="mb-3">
													...
													<div className="row">
														<div className="col-lg-10 col-sm-10 col-10">
															<Select classNamePrefix="react-select" options={CustomerName} placeholder="Choose" />
														</div>
														<div className="col-lg-2 col-sm-2 col-2 ps-0">
															<div className="add-icon">
																<Link href="#" className="bg-dark text-white p-2 rounded">
																	<PlusCircle />
																</Link>
															</div>
														</div>
											...
											<div className="col-lg-4 col-sm-6 col-12">
												<div className="mb-3">
													...
													<Select classNamePrefix="react-select" options={Supplier} placeholder="Choose" />
												</div>
											</div>
												...
												<div className="mb-3">
													...
													<div className="input-groupicon select-code">
														...
														<div className="addonset">
															<Image src="/assets/img/icons/qrcode-scan.svg" alt="img" width={20} height={20} />
														</div>
													</div>
												</div>
											</div>
										...
										<div className="row">
											...
											<div className="col-lg-3 col-sm-6 col-12">
												<div className="mb-3 mb-5">
													...
													<Select classNamePrefix="react-select" options={OrderStatus} placeholder="Choose" />
												</div>
											</div>
										</div>
									</div>
								...
								<ul className="table-top-head">
									<li>
										<Link href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf">
											<Image src="/assets/img/icons/pdf.svg" alt="img" width={20} height={20} />
										</Link>
									</li>
									<li>
										<Link href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf">
											<Image src="/assets/img/icons/printer.svg" alt="img" width={20} height={20} />
										</Link>
									</li>
								</ul>
													...
													<div className="col-lg-12 col-sm-6 col-12">
														<div className="mb-3">
															...
															<div className="input-groupicon select-code">
																...
																/>
																<div className="addonset">
																	<Image src="/assets/img/icons/scanners.svg" alt="img" width={20} height={20} />
																</div>
															</div>
														</div>
													</div>
														...
														<tr>
															...
															<td>
																<div className="edit-delete-action d-flex align-items-center">
																	<Link className="me-3 p-2 border rounded d-flex align-items-center" href="#">
																	...
																	<Link className="p-2 border rounded d-flex align-items-center" href="#">
									...
									<div className="row">
										...
										<div className="col-lg-4 col-sm-12 col-12">
											<div className="mb-3">
												...
												<Select classNamePrefix="react-select" options={PaymentType} placeholder="Choose" />
											</div>
										</div>
										<div className="col-lg-12">
											<div className="mb-3">
