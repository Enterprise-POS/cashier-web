			...
			<div className="modal-dialog modal-dialog-centered">
				<div className="modal-content">
						...
						<div className="row">
							<div className="col-lg-6 pe-0">
								<div className="mb-3">
									...
									{isMounted ? (
										<Select classNamePrefix="react-select" options={barcodesymbol} placeholder="Choose" />
									) : null}
								</div>
							</div>
							<div className="col-lg-6">
								<div className="mb-3">
									<div className="mb-3 add-product list position-relative">
										...
										<input type="text" className="form-control list" defaultValue="" />
										...
										<div className="col-lg-12">
											<div className="add-choosen mb-3">
												<div className="phone-img ms-0">
													...
													<Link href="#">
														<X data-feather="x" className="x-square-add remove-product" />
													</Link>
												</div>
							...
							<div className="col-lg-6">
								<div className="mb-3">
									...
									{isMounted ? <Select classNamePrefix="react-select" options={tax} placeholder="Choose" /> : null}
								</div>
							</div>
							<div className="col-lg-6">
								<div className="mb-3">
									...
									{isMounted ? <Select classNamePrefix="react-select" options={taxtype} placeholder="Choose" /> : null}
								</div>
							</div>
							<div className="col-lg-6">
								<div className="mb-3">
					...
					<div className="modal-footer">
						...
						<Link href="#" className="btn btn-primary fs-13 fw-medium p-2 px-3">
							Submit
						</Link>
					</div>
				</div>
