...
import { Category, Store, WareHouse } from '@/components/core/json/selectOption';
import Select from 'react-select';
import Link from 'next/link';

export default function EditLowStock() {
	return (
		<>
			{/* Edit Low Stock */}
						...
						<div className="page-wrapper-new p-0">
							<div className="content">
								...
								<div className="modal-footer">
									...
									<Link data-bs-dismiss="modal" href="#" className="btn btn-primary fs-13 fw-medium p-2 px-3">
										Save Changes
									</Link>
								</div>
							</div>
