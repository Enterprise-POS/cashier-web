...
import AddUsers from '@/components/user_management/AddUser';
import EditUser from '@/components/user_management/EditUser';
import { userlisadata } from '@/components/core/json/users';
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link href="#" className="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-units">
