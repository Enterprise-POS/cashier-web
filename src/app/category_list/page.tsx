...
import { categorylist } from '@/components/core/json/categorylistdata';
...
export default function Home() {
	...
	const columns = [
		...
		},
		{
			title: 'Status',
			dataIndex: 'status',
			render: (text: any) => <span className="badge bg-success fw-medium fs-10">{text}</span>,
			...
			render: () => (
				<div className="action-table-data">
					<div className="edit-delete-action">
						<Link className="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-category">
