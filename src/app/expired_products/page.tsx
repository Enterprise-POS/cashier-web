...
export default function ExpiredProductsComponent() {
	...
	const columns = [
		...
		},
		{
			...
			sorter: (a: any, b: any) => a.manufactureddate.length - b.manufactureddate.length,
		},
		{
			title: 'Expired Date',
			...
			render: () => (
				<div className="action-table-data">
					<div className="edit-delete-action">
						<Link data-bs-toggle="modal" data-bs-target="#add-units" className="me-2 p-2" href="#">
							<i data-feather="edit" className="feather-edit"></i>
						</Link>
						<Link href="#" data-bs-toggle="modal" data-bs-target="#delete-modal" className="p-2">
