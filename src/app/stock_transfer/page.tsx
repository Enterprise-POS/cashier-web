...
import { Download, Edit, MinusCircle, PlusCircle, Trash2 } from 'react-feather';
import Link from 'next/link';
import { useEffect, useState } from 'react';
import Select from 'react-select';
import { WarehouseFrom, WarehouseTo, From, To, Status } from '@/components/core/json/selectOption';
import DefaultEditor from 'react-simple-wysiwyg';
import Footer from '@/components/partials/footer';
import CommonDeleteModal from '@/components/inventory/modal/commonDeleteModal';
import { StockTransferData } from '@/components/core/json/stocktransferdata';
	...
	const columns = [
		{
			...
			sorter: (a: any, b: any) => a.fromWarehouse.length - b.fromWarehouse.length,
		},
		{
			title: 'To Warehouse',
...

		{
			...
			sorter: (a: any, b: any) => a.quantityTransferred.length - b.quantityTransferred.length,
		},
								...
								<div className="row">
									<div className="col-lg-6">
										<div className="mb-3">
											...
											<Select classNamePrefix="react-select" options={WarehouseFrom} placeholder="Choose" />
										</div>
									</div>
									<div className="col-lg-6">
										<div className="mb-3">
											...
											<Select classNamePrefix="react-select" options={WarehouseTo} placeholder="Choose" />
										</div>
									</div>
								...
								<div className="row">
									<div className="col-lg-4 col-sm-6 col-12">
										<div className="mb-3">
											...
											<Select classNamePrefix="react-select" options={From} placeholder="Choose" />
										</div>
									</div>
									<div className="col-lg-4 col-sm-6 col-12">
										<div className="mb-3">
											...
											<Select classNamePrefix="react-select" options={To} placeholder="Choose" />
										</div>
									</div>
									<div className="col-lg-4 col-sm-6 col-12">
										<div className="mb-3">
