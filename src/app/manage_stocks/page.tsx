...
import { ResponsiblePerson, Shop, Store, WareHouse } from '@/components/core/json/selectOption';
...
import { Edit, MinusCircle, PlusCircle, Search, Trash2 } from 'react-feather';
								...
								<div className="row">
									...
									<div className="col-lg-12">
										<div className="mb-3">
											...
											<Select classNamePrefix="react-select" options={Shop} placeholder="Choose" />
										</div>
									</div>
									<div className="col-lg-12">
										<div className="mb-3">
