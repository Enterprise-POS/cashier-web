...
import { lowstockdata } from '@/components/core/json/lowstockdata';
import Link from 'next/link';
import Table from '@/components/pagination/datatable';
import EditLowStock from '@/components/inventory/modal/editLowStock';
			...
			render: () => (
				<div className="action-table-data">
					<div className="edit-delete-action">
						<Link className="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-stock">
				...
				<div className="modal-dialog modal-dialog-centered">
					<div className="modal-content">
						<div className="success-email-send modal-body .custom-modal-body text-center">
							...
							<Link href="#" className="btn btn-primary p-1 px-2 fs-13 fw-normal" data-bs-dismiss="modal">
								Close
							</Link>
						</div>
					</div>
