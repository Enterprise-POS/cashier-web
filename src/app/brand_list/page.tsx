...
import { brandlistdata } from '@/components/core/json/brandlistdata';
...
export default function BrandListComponent() {
	...
	const columns = [
		...
		},
		{
			title: 'Status',
			dataIndex: 'status',
			render: (text: any) => <span className="badge table-badge bg-success fw-medium fs-10">{text}</span>,
			...
			render: () => (
				<div className="action-table-data">
					<div className="edit-delete-action">
						<Link className="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-brand">
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link href="#" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-brand">
									...
									<div className="modal-body custom-modal-body new-employee-field">
										<form>
											<div className="profile-pic-upload mb-3">
												<div className="profile-pic brand-pic">
													<span>
														<img src="assets/img/brand/brand-icon-02.png" alt="Img" />
													</span>
