															...
															<table className="table datatable">
																...
																<tbody>
																	<tr>
																		...
																		{/* <td>
																			<div className="status-toggle modal-status d-flex justify-content-between align-items-center">
																				<input type="checkbox" id="users1" className="check" defaultChecked />
																		...
																		<td>
																			<div className="status-toggle modal-status d-flex justify-content-between align-items-center">
																				<input type="checkbox" id="status1" className="check" defaultChecked />
												...
												<div className="d-flex align-items-center">
													<div className="back-btn">
														<Link href={all_routes.languageSettings} className="btn btn-secondary me-3">
															<i data-feather="arrow-left" className="filter-icon me-2" />
															Back to Translations{' '}
														</Link>
													</div>
													<div className="page-btn me-2">
														<Link href="#" className="d-flex align-items-center selected-language">
															<img src="/assets/img/icons/flag-03.svg" className="me-2" alt="Img" />
															Arabic
														</Link>
													</div>
													<div>
