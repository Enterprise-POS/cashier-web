...
import { onlineOrderData } from '@/components/core/json/onlineorderdata';
import CommonDeleteModal from '@/components/inventory/modal/commonDeleteModal';
import OnlineOrderModal from '@/components/online_orders/OnlineOrderModal';
...
export default function PosOrderComponent() {
	...
	const columns = [
			...
			render: (render: any) => (
				<span
					className={`badge badge-xs shadow-none ${
						render === 'Unpaid' ? 'badge-soft-danger' : render === 'Paid' ? 'badge-soft-success' : 'badge-soft-warning'
					} `}
				>
...

		{
			...
			render: () => (
				<>
					<Link className="action-set" href="#" data-bs-toggle="dropdown" aria-expanded="true">
						<i className="fa fa-ellipsis-v" aria-hidden="true" />
					</Link>
					<ul className="dropdown-menu">
						<li>
							<Link href="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#sales-details-new">
								<Eye className="info-img" />
								Sale Detail
							</Link>
						</li>
						<li>
							<Link href="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-sales-new">
								<Edit className="info-img" />
								Edit Sale
							</Link>
						</li>
						<li>
							<Link href="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#showpayment">
								<DollarSign className="info-img" />
								Show Payments
							</Link>
						</li>
						<li>
							<Link href="#" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#createpayment">
						...
						<li>
							<Link href="#" className="dropdown-item mb-0" data-bs-toggle="modal" data-bs-target="#delete-modal">
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link href="#" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sales-new">
