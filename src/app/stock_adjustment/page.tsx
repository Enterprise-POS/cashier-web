...
import { ManageStocksdata } from '@/components/core/json/managestockdata';
import { Addition, ResponsiblePerson, Store, WareHouse } from '@/components/core/json/selectOption';
...
import { Edit, FileText, MinusCircle, PlusCircle, Search, Trash2 } from 'react-feather';
			...
			render: () => (
				<div className="action-table-data">
					<div className="edit-delete-action">
						...
						<Link className="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#view-notes">
													...
													<table className="table  datanew">
														...
														<tbody>
															<tr>
																...
																<td>
																	<Select classNamePrefix="react-select" options={Addition} placeholder="Choose" />
																</td>
																<td>
