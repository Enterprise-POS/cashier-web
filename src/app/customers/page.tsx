...
import { CustomerData } from '@/components/core/json/customerdata';
import { city, countries, state } from '@/components/core/json/selectOption';
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link href="#" className="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#add-units">
							...
							<div className="page-wrapper-new p-0">
								<div className="content">
										...
										<form>
											...
											<div className="row">
												...
												<div className="col-lg-6 mb-3">
													...
													<Select classNamePrefix="react-select" options={countries} placeholder="Choose" />
												</div>
												<div className="col-lg-6 mb-3">
													<label className="form-label">
									...
									<div className="modal-footer">
										...
										<Link href="#" className="btn btn-primary fs-13 fw-medium p-2 px-3" data-bs-dismiss="modal">
											Add Customer
										</Link>
									</div>
								</div>
							...
							<div className="page-wrapper-new p-0">
								<div className="content">
									...
									<div className="modal-footer">
										...
										<Link href="submit" className="btn btn-primary fs-13 fw-medium p-2 px-3" data-bs-dismiss="modal">
											Save Changes
										</Link>
									</div>
								</div>
						...
						<div className="modal-content">
							<div className="page-wrapper-new p-0">
								<div className="content p-5 px-3 text-center">
									...
									<p className="mb-0 fs-16">Are you sure you want to delete customer?</p>
